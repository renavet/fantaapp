...
df2 = pd.read_excel('/home/renato/fanta-app/Quotazioni_Fantacalcio_Stagione_2024_25.xlsx', skiprows=1)
...
df.to_csv('/home/renato/fanta-app/dati_uniti.csv', index=False)
